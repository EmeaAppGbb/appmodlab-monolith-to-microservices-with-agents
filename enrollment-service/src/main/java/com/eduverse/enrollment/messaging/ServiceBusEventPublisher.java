package com.eduverse.enrollment.messaging;
...
public class ServiceBusEventPublisher {
    ...
    public void publishStudentEnrolled(DomainEvent event) {
        publish("student-enrolled", event);
    }

    public void publishEnrollmentActivated(DomainEvent event) {
        publish("enrollment-activated", event);
    }

    public void publishEnrollmentCompleted(DomainEvent event) {
