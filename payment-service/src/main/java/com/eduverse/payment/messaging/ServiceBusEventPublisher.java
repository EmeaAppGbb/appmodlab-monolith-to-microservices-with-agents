...
public class ServiceBusEventPublisher {
    ...
    public void publishPaymentCompleted(DomainEvent event) {
        publish("payment-completed", event);
    }

    public void publishPaymentFailed(DomainEvent event) {
        publish("payment-failed", event);
    }

    public void publishPaymentRefunded(DomainEvent event) {
