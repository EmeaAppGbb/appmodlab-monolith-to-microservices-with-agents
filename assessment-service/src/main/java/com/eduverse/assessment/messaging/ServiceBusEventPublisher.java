package com.eduverse.assessment.messaging;
...
public class ServiceBusEventPublisher {
    ...
    public void publish(String topic, DomainEvent event) {
        event.setSource("assessment-service");
    ...
    public void publishAssessmentPassed(DomainEvent event) {
        publish("assessment-passed", event);
    }
}
