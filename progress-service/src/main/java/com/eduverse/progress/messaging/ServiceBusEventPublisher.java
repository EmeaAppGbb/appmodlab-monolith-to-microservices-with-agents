package com.eduverse.progress.messaging;
...
public class ServiceBusEventPublisher {
    ...
    public void publish(String topic, DomainEvent event) {
        event.setSource("progress-service");
    ...
    public void publishProgressUpdated(DomainEvent event) {
        publish("progress-updated", event);
    }

    public void publishLessonCompleted(DomainEvent event) {
